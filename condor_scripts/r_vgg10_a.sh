...
#RESTORE_PATH="/scratch/cluster/joeliven/carproject/models/vgg10a/vgg10_a_checkpoint-99"
# SAVE_PATH="models/vgg"
SAVE_PATH="/scratch/cluster/joeliven/carproject/models/vgg10a"
