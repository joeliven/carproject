...
#RESTORE_PATH="/scratch/cluster/joeliven/carproject/models/vgg6f/vgg6f_a_checkpoint-99"
# SAVE_PATH="models/vgg"
SAVE_PATH="/scratch/cluster/joeliven/carproject/models/vgg6f"
