...
class VGG1(object):
    def __init__(self, **kwargs):
        ...
        self.nb_channels_int = kwargs.get('dim_img', 224)
            ...
            for step in range(max_iters):
                ...
                if step % 50 == 0: # 100
                    ...
                    for samp_num in range(cur_batch.shape[0]):
                        ...
                        ax[0].text(0, 0, txt, color='r', fontsize=25, fontweight='bold')
                        plt.show()
                ...
                if (step + 1) % 50 == 0 or (step + 1) == max_iters: # 1000
    ...
    def predict(self, **kwargs):
        ...
        with tf.Graph().as_default():
            ...
            for samp_num in range(X.shape[0]):
                ...
                ax[0].text(0, 0, txt, color='b', fontsize=25, fontweight='bold')
                plt.show()
    ...
    def load_weights_encoder(self, weights, sess):
        ...
        pdb.set_trace() # TODO: figure out what the FC layer weights are named in the pretraied weights file...
...
if __name__ == '__main__':
    ...
    X_train_file = 'data/preprocessed/gdc_3s/X_train.npy'
    y_train_file = 'data/preprocessed/gdc_3s/y_train.npy'
    ...
    X_val = X_train[TRAIN_LIM: TRAIN_LIM+VAL_LIM]
    y_val = y_train[TRAIN_LIM: TRAIN_LIM+VAL_LIM]
